...
var insertFragment = function insertFragment(contentState, selectionState, blockMap, fragment, targetKey, targetOffset) {
  var _blockMap$first;
  var isTreeBasedBlockMap = typeof ((_blockMap$first = blockMap.first()) === null || _blockMap$first === void 0 ? void 0 : _blockMap$first.findEntityRanges) === 'function';
  var newBlockArr = [];
...
var insertFragmentIntoContentState = function insertFragmentIntoContentState(contentState, selectionState, fragmentBlockMap) {
  ...
  var targetBlock = blockMap.get(targetKey);
  if (typeof (targetBlock === null || targetBlock === void 0 ? void 0 : targetBlock.getChildKeys()) === 'function') {
