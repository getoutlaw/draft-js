...
function editOnInput(editor, event) {
  ...
  var isDeleteWordForward =
  // $FlowFixMe[prop-missing] Flow doesn't know if can be an InputEvent w/ inputType
  (event === null || event === void 0 ? void 0 : (_event$nativeEvent = event.nativeEvent) === null || _event$nativeEvent === void 0 ? void 0 : _event$nativeEvent.inputType) === 'deleteWordForward';
