...
function getPointForNonTextNode(editorRoot, startNode, childOffset) {
  ...
  if (editorRoot === node) {
    ...
    node = node.firstChild;
    !isElement(node) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Invalid DraftEditorContents node. Expected element but instead got a node with type of %s.', [(_node = node) === null || _node === void 0 ? void 0 : _node.nodeType]) : invariant(false) : void 0;
    var castedNode = node;
